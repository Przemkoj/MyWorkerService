...
namespace DotNetCoreWCF.Proxies.Factories
{
	public static class ProxyFactoryExtensions
	{
		...
		public static System.ServiceModel.EndpointAddress GetEndpointAddress(this IClientProxySettings settings)
		{
			...
			var endpointIdentity = new System.ServiceModel.DnsEndpointIdentity(settings.DnsIdentity);
		...
		public static System.ServiceModel.Channels.Binding GetBasicHttpBinding(this IBasicHttpClientProxySettings settings)
		{
			if (!settings.Enabled)
				return null;
